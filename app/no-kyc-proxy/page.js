...
export default function NoKycProxyPage() {
    const jsonLd = {
        ...
        "description": "ProxyBase is a genuinely KYC-free residential and mobile proxy network. No identity verification, no documents, no compliance calls. Pay with crypto, get access in 60 seconds.",
        "url": "https://proxybase.xyz/no-kyc-proxy"
    };
            ...
            <div className="compare-page-root">
                ...
                <section className="compare-intro-section" id="why-kyc">
                    <div className="section-header" style={{ marginBottom: "48px", textAlign: "center" }}>
                        ...
                        <p className="section-desc" style={{ maxWidth: "700px", margin: "0 auto" }}>
                            KYC ("Know Your Customer") is standard in the proxy industry. But it's not about security — it's about control.
                        </p>
                    </div>
                    ...
                    <div className="intro-card-grid">
                        <div className="intro-card ir-card">
                            ...
                            <p className="brand-desc">
                                Big proxy companies like BrightData, Oxylabs, and Smartproxy require KYC because they operate centralized networks that sell to enterprise clients with compliance requirements. Your passport and company docs protect their legal department — not you. They share data with regulators, store your identity on file, and reserve the right to suspend your account if your use case doesn't match their "acceptable use" policy.
                            </p>
                        ...
                        <div className="intro-card pb-card">
                            ...
                            <p className="brand-desc">
                                ProxyBase is a decentralized marketplace. When you buy proxy access, you're paying individual bandwidth sellers directly through crypto transactions. There's no central authority that needs to verify who you are — the blockchain verifies the payment, and the network routes your traffic. No identity layer exists because the architecture doesn't need one.
                            </p>
                            <ul className="brand-bullets">
                                <li>⚡ Pay with USDC, USDT, BTC, ETH, or SOL — that's your authentication</li>
                                <li>⚡ No name, no email, no phone number, no documents</li>
                                <li>⚡ Proxy access in under 60 seconds — fully automated</li>
                                <li>⚡ Your payment history is on-chain; your identity is nowhere</li>
                            </ul>
                        </div>
                    </div>
                </section>
                ...
                <section className="compare-matrix-section" style={{ borderTop: "1px solid var(--border-subtle)" }}>
                    <div className="section-header">
                        ...
                        <p className="section-desc">Most "no KYC" claims in the proxy industry are misleading. Here's the truth.</p>
                    </div>
                        ...
                        <table className="compare-matrix-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="text-emerald font-weight-bold">No — genuinely KYC-free</td>
                ...
                <section className="compare-deepdive-section" style={{ background: "var(--bg-secondary)" }}>
                    <div className="section-header">
                        ...
                        <p className="section-desc">Genuinely private proxy access matters for more than just privacy enthusiasts.</p>
                    </div>
                    ...
                    <div className="deepdive-grid">
                        <div className="deepdive-card">
                            ...
                            <p>
                                Your LLM agent needs to provision proxies programmatically. It can't upload a passport photo or wait 2 weeks for compliance approval. ProxyBase's API lets your agent register, pay, and get proxy credentials entirely autonomously — no human in the loop.
                            </p>
                        </div>
                        ...
                        <div className="deepdive-card">
                            ...
                            <p>
                                Many proxy companies block signups from certain countries entirely. Others require local ID documents that don't exist where you live. ProxyBase is globally accessible — if you can make a crypto transaction, you can use the network.
                            </p>
                        </div>
                        ...
                        <div className="deepdive-card">
                            ...
                            <p>
                                Enterprise proxy companies don't want your $20/month business. Their compliance overhead is designed for $10K+/month contracts. ProxyBase welcomes small-scale users — pay $3 and start proxying. No minimum, no sales call.
                            </p>
                        </div>
                        ...
                        <div className="deepdive-card">
                            ...
                            <p>
                                If you earn and spend in crypto, traditional proxy providers are inaccessible — they require credit cards and bank accounts. ProxyBase is crypto-native: pay with stablecoins or any major cryptocurrency directly from your wallet.
                            </p>
                        </div>
                ...
                <section className="compare-deepdive-section" style={{ background: "var(--bg-secondary)" }}>
                    ...
                    <div className="deepdive-grid grid-2-cols">
                        ...
                        <div className="deepdive-card">
                            ...
                            <p>
                                ProxyBase is fully open-source. Every line of the relay client and gateway is on GitHub. You don't need to trust us — you can audit the code yourself. Our decentralized architecture means no single entity controls the network.
                            </p>
                        </div>
                        ...
                        <div className="deepdive-card">
                            ...
                            <p>
                                Many providers market themselves as "no KYC" for small purchases, then trigger verification when you exceed limits or use certain features. Others require identity verification at signup but call it "fraud prevention." ProxyBase has no verification triggers — you can deposit any amount and use the full network without ever identifying yourself.
                            </p>
                        </div>
                        ...
                        <div className="deepdive-card">
                            ...
                            <p>
                                Cryptocurrency and stablecoins only. Credit cards and PayPal inherently require identity verification through the payment processor. ProxyBase accepts USDC, USDT, BTC, ETH, SOL, and other major cryptocurrencies — all without linking to your real-world identity.
                            </p>
                        </div>
                        ...
                        <div className="deepdive-card">
                            ...
                            <p>
                                No — ProxyBase is actually cheaper than most KYC providers. Residential proxies at $3/GB vs BrightData's $8.40/GB (with KYC). The cost savings come from the decentralized architecture: no compliance department, no legal overhead, no manual account reviews to pay for.
                            </p>
                        </div>
                    </div>
                </section>
