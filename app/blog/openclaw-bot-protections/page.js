...
export default function OpenClawBotProtections() {
 ...
 <meta name="description" content="A deep dive into why OpenClaw's web_fetch fails on protected sites, the progression of anti-bot IP blocking, and how to scrape with AI agents." />
 </Head>
 <Navbar />
 ...
 <p style={{ marginBottom: "2.5rem" }}>
 <strong>The immediate solution:</strong> Use the dedicated ProxyBase skill for OpenClaw. You can view the skill on the <a href="https://clawhub.ai/proxybase-user/proxybase-openclaw-skill" target="_blank" rel="noopener noreferrer" style={{ color: "var(--accent-primary)", textDecoration: "none", fontWeight: "bold" }}>ClawHub Registry</a> or install it directly via your terminal:
 </p>
