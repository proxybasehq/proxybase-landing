...
try:
    ...
    print("Connection failed:", e)`}
                        ...
                        <ul style={{ paddingLeft: "1.5rem", marginBottom: "2.5rem" }}>
                            ...
                            <li style={{ marginBottom: "10px" }}><strong>No KYC Obstacles:</strong> Fund your account using cryptocurrency and start routing traffic instantly—no complex setup or verification required.</li>
